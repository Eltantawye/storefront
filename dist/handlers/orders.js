...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authorizationHeader, token, decodedToken, userId, orders, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                userId = decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken.user.id;
                return [4 /*yield*/, store.index(parseInt(userId))];
            case 1:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 3];
